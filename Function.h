...
//void sortAll__1(UND*Head_1);   //按总成绩从高到低排序Head_1链表,并计算班排名
//void sortAll__2(GRA*Head_2);   //按总成绩从高到低排序Head_2链表,并计算班排名
//void CalculateClassRankings();    //计算各班级排名
void release_1(UND*Head_1);   //释放以Head_1为头的链表空间
void release_2(GRA*Head_2);   //释放以Head_2为头的链表空间
//-------
...
//    }class1;
//
//    char classzonglei_1[20][10]={NULL};   //班级种类
//    int j=0;   //班级种类数
//    class1  classzonglei_2[20]={NULL};   //班级种类
//    int k=0;   //班级种类数
//
//    //(1)----获取班级种类数量
//    while(Head_1->next!=NULL){
...
//    //(4)----获取各班级总人数
//    //(5)----修改主链表排名
//    int p1;   //记录节点对应的班级种类引索
//    int p2;   //记录节点对应的班级种类引索
//    while(Head_1->next!=NULL) {
//        for (int i = 0; i < j; i++) {
